...
-- The interface uses its clearly separated TypeScript development fixture until
-- a real Supabase project is connected. Do not seed fabricated approved businesses
